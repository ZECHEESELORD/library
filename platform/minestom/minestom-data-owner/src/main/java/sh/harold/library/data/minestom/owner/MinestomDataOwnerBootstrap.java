package sh.harold.library.data.minestom.owner;

import sh.harold.library.data.DataApi;
import sh.harold.library.data.DocumentStore;
import sh.harold.library.data.SharedDataProvider;
import sh.harold.library.data.core.CaffeineDocumentStore;
import sh.harold.library.data.core.ConfiguredSharedDataProvider;
import sh.harold.library.data.core.ReflectiveSharedDataBridgeEndpoint;
import sh.harold.library.data.core.StoreBackedDataApi;
import sh.harold.library.data.memory.InMemoryDocumentStore;
import sh.harold.library.data.minestom.MinestomSharedDataBridge;
import sh.harold.library.data.mongodb.MongoDocumentStore;
import sh.harold.library.data.yaml.YamlDocumentStore;
