...
import sh.harold.library.boundary.BoundaryProvider;
import sh.harold.library.boundary.BoundarySnapshot;
import sh.harold.library.boundary.core.IndexedBoundaryAuthority;
...
public final class PaperBoundaryAuthority implements BoundaryProvider {

    private final IndexedBoundaryAuthority authority;

    public PaperBoundaryAuthority() {
