package sh.harold.library.boundary.paper;
...
class PaperBoundaryServicesTest {
    ...
    private static final class TestBoundaryService implements BoundaryService {
        ...
        @Override
        public Optional<sh.harold.library.boundary.BoundarySnapshot> boundaryAt(
                sh.harold.library.spatial.SpaceId spaceId,
                sh.harold.library.blockgrid.BlockPos block
        ) {
            return Optional.empty();
        }

        @Override
        public List<sh.harold.library.boundary.BoundarySnapshot> boundariesIntersecting(
                sh.harold.library.spatial.SpaceId spaceId,
                sh.harold.library.blockgrid.BlockBounds bounds
        ) {
            return List.of();
        }
