...
import sh.harold.library.cooldown.CooldownKey;
import sh.harold.library.cooldown.CooldownKeys;
import sh.harold.library.cooldown.CooldownRef;
import sh.harold.library.cooldown.CooldownRegistry;
import sh.harold.library.cooldown.CooldownScope;
import sh.harold.library.cooldown.CooldownSpec;
import sh.harold.library.cooldown.CooldownRefs;
import sh.harold.library.cooldown.core.InMemoryCooldownRegistry;
