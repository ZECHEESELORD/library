package sh.harold.library.example.fabric.client;

import net.fabricmc.api.ClientModInitializer;
import net.fabricmc.fabric.api.client.event.lifecycle.v1.ClientLifecycleEvents;
import net.fabricmc.fabric.api.client.event.lifecycle.v1.ClientTickEvents;
import sh.harold.library.message.Message;
import sh.harold.library.message.fabric.client.FabricClientMessageSender;
import sh.harold.library.sound.SoundCueKeys;
import sh.harold.library.sound.fabric.client.FabricClientSoundCuePlatform;
