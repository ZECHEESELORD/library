package sh.harold.library.metrics.prometheus;
...
import sh.harold.library.metrics.core.StandardTelemetry;
...
class PrometheusFormatterTest {
    ...
    void escapesLabelValuesAndHelpText() {
        ...
        StandardTelemetry telemetry = new StandardTelemetry();
        telemetry.unsafe().increment(counter, sh.harold.library.metrics.UnsafeMetricLabels.of("channel", "ops\"room"));
